                                    ...
                                    <?php
                                     ...
                                     ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row['product_cat']; ?></td></tr>
                                            ...
                                            <tr>
                                            <td>Product Desc</td>
                                            <td><?php echo $row['product_desc']; ?></td></tr>
                                        ...
                                        <!-- <tr class="response">
                                          <td><//?php echo $i; ?></td>
                                            ...
                                            <td style="text-align:center;">
                                                 ...
                                                 <a href="#"><span style="vertical-align:middle;" class="ti-eye"></span> </a> |
                                                 <a href="update.php?product_id=<//?php echo $row["product_id"]; ?>"><span style="vertical-align:middle;" class="ti-pencil-alt"></span></a> |
                                                 <a href="#"> <span style="color:red; vertical-align:middle;" class="ti-trash"></span></a>
                                             </td>
